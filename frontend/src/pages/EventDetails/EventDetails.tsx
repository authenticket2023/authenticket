                  ...
                  <Grid item xs={8}>
                    <Grid container spacing={2}>
                      ...
                      {categoryDetails.map((cat: any) => (
                        ...
                        >
                          {" "}
                          {/* xs={6} makes each item take up half the row */}
                          <div
                            style={{
                              background: colorArray[cat.categoryId - 1],
                              height: "20px",
                              width: "20px",
                              borderRadius: "5px",
                            }}
                  ...
                  <Grid item xs={8}>
                    ...
                    >
                      ...
                      <strong style={{ fontWeight: 500 }}>
                        {formatDate(eventDetails.ticketSaleDate)} @{" "}
                        {formatTime(eventDetails.ticketSaleDate)}
                      </strong>
                    </Typography>
                    <Typography
                      style={{
                    ...
                    <Typography>
                      ...
                      >
                        ...
                        >
                          If the event has a presale, please indicate your
                          interest to be considered for the presale
                        </ListItem>
                        <ListItem
                          sx={{
                            display: "list-item",
