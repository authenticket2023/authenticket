...
export default function displayEvent(props: eventInfo) {
  return (
    <Card
      sx={{
        minHeight: 260,
    ...
    >
      <CardActionArea href={`/EventDetails/${props.event.eventId}`}>
        <CardMedia
          ...
          image={`${process.env.REACT_APP_S3_URL}/event_images/${props.event.eventImage}`}
          alt="event image"
        />
        <CardContent
          style={{ justifyContent: "left", alignItems: "left", marginLeft: 18 }}
        >
          <Typography
            gutterBottom
            variant="h5"
